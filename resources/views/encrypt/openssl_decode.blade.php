...
<meta name="description" content="openssl支持多种加密算法，多种加密模式。在线解密工具[Online decrypt tool] - 在线JSON校验格式化工具(OK JSON)">
@stop

@section('title')
Openssl decode 在线解密工具[Online decrypt tool] - 在线JSON校验格式化工具(OK JSON)
@stop
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="alert alert-success" role="alert">
            <p>注意：解密前会对输入内容进行<code>base64_decode()</code></p>
        </div>

        <textarea class="form-control data" placeholder="要解密的数据" rows="5"></textarea>
        ...
        <p class="text-muted">工具使用PHP中的openssl_encrypt()相关函数，有关参数，更多信息请<a href="http://www.php.net/manual/en/function.openssl-decrypt.php" target="_blank">查看手册</a>。</p>
