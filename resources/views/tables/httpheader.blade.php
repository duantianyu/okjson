...
@section('meta')
<meta name="keywords" content="HTTP请求头大全 请求头 HTTP请求头响应头 响应头">
<meta name="description" content="HTTP请求头,响应头大全 - 在线JSON校验格式化工具(OOK JSON)">
@stop

@section('title')
HTTP请求头,响应头大全 - 在线JSON校验格式化工具(OOK JSON)
@stop
...
@include('tables.tab')
    ...
    <div class="panel-body">
        ...
        <h3>HTTP Request Header <small>请求头</small></h3>
        ...
        <h3>HTTP Responses Header <small>响应头</small></h3>
        <table class="table table-bordered list">
